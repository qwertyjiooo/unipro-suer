	...
	<view class="centent">
		<view class="" style="padding:0 20rpx 20rpx;">
			...
			<view class="personal">
				...
				<view class="welcome">
					<view class="user" v-if="orderformList.status===0">待旅行</view>
					<view class="user" v-else-if="orderformList.status===1">已完成</view>
					<view class="user" v-else-if="orderformList.status===2">已取消</view>
					<view class="user" v-else></view>
					<view class="logout">订单
						<span class="logout" v-if="orderformList.status===0">待旅行,</span>
						<span class="logout" v-else-if="orderformList.status===1">已完成,</span>
						<span class="logout" v-else-if="orderformList.status===2">已取消,</span>
						<span class="logout" v-else></span>
						感谢您的使用,祝您快乐每一程
					</view>
				</view>
			</view>
			...
			<view class="customization rou">
				...
				<view class="date">
					<view class="Destination">预约单号</view>
				...
				<view class="date" v-if="orderformList.enterpriseName">
					<view class="Destination">企业名称</view>
					<view class="example-body">
						<view class="DestinationStuta">{{orderformList.enterpriseName}}</view>
					</view>
				</view>
